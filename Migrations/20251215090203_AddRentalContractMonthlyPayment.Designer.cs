...
namespace RentMaster.Migrations
{
    ...
    [Migration("20251215090203_AddRentalContractMonthlyPayment")]
    partial class AddRentalContractMonthlyPayment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentMaster.Core.Models.PaymentTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RentMaster.Management.ConsumerContact.Models.ConsumerContact", b =>
                {
                    b.Property<Guid>("Uid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("Apartment_UID")
                        .HasColumnType("uuid");

                    b.Property<Guid>("Consumer_Uid")
                        .HasColumnType("uuid");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid>("Landlord_Uid")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Consumer_Uid");

                    b.HasIndex("Landlord_Uid");
            ...
            modelBuilder.Entity("RentMaster.Management.RentalContract.Models.RentalContract", b =>
                {
                    b.Property<Guid>("Uid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.PrimitiveCollection<List<Guid>>("ParticipantUids")
                        .HasColumnType("uuid[]");

                    b.Property<Guid>("ResponsibleUid")
                        .HasColumnType("uuid");
